...
router.post(
  ...
  authorize(["ADMIN"]),
  upload.single("image"),
  optimizeImage("hotels", { outputFormat: "webp" }),
  createHotel,
);
...
router.post(
  ...
  authorize(["ADMIN"]),
  upload.single("logo"),
  optimizeImage("airlines", { outputFormat: "webp" }),
  createAirline,
);
...
router.post(
  ...
  authorize(["ADMIN"]),
  upload.single("image"),
  optimizeImage("gallery", { outputFormat: "webp" }),
  createGallery,
);
router.put(
  "/gallery/:id",
...
router.post(
  ...
  optimizeImage("articles", { outputFormat: "webp" }),
  createArticle,
);
router.post(
  "/articles/images",
...
router.post(
  ...
  authorize(["ADMIN"]),
  upload.single("logo"),
  optimizeImage("company", { outputFormat: "webp" }),
  uploadCompanyLogo,
);
...
router.get(
  "/agent-levels",
  authenticate,
  authorize(["ADMIN", "AGEN", "STAFF", "FINANCE"]),
