        ...
        <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-4 py-24 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
          <div>
            ...
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-2 text-sm font-semibold text-gold">
              ...
              Akses Akun Sahabat Qolbu
            </div>

            <h1 className="max-w-2xl text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
              Masuk dashboard atau daftar sebagai agen dalam satu halaman.
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/80">
              Gunakan tab login untuk masuk ke dashboard. Kalau belum punya
              akun agen, buka tab register dan kirim data singkat ke tim kami.
            </p>
          ...
          <div className="rounded-3xl border border-white/20 bg-white p-5 text-primary shadow-2xl sm:p-7">
            <div className="mb-6 grid grid-cols-2 rounded-2xl bg-primary-50 p-1">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-extrabold text-primary">
                    Masuk untuk lanjut mengelola akun
                  </h2>
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Login Sahabat Qolbu memakai OTP email di dashboard. Setelah
                    masuk, Anda akan diarahkan sesuai role akun.
                  </p>
                </div>
                  ...
                  {checkingSession ? (
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-neutral-600">
                          {sessionUser.fullName || "Pengguna"} sudah login.
                          Lanjutkan ke dashboard.
                        </p>
                      </div>
                      <a
                        href={dashboardUrl}
                        className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-bold text-white transition hover:bg-primary-600"
                      >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-neutral-600">
                          Klik tombol di bawah untuk masuk via dashboard.
                        </p>
                      </div>
                      <a
                ...
                <button
                  ...
                  className="w-full rounded-2xl border border-primary/15 px-5 py-4 text-sm font-bold text-primary transition hover:bg-primary hover:text-white"
                >
                  Belum punya akun? Register jadi agen
                </button>
              </div>
            ) : (
              <>
                <div className="mb-6">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Data ini akan dikirim ke WhatsApp admin agar tim bisa
                    membuat akun dan menjelaskan tahap berikutnya.
                  </p>
                </div>
